...
class MapTest {
    ...
    void testIsInside() {
        ...
        assertFalse(_m3_3.isInside(new Index2D(3, 3)));
    ...
    void testFill_NonCyclic() {
        ...
        int changed = _m3_3.fill(new Index2D(0, 0), 5);
    ...
    void testFill_Cyclic() {
        ...
        map.setPixel(1, 1, 1);
        map.setPixel(2, 1, 1);
        int changed = map.fill(new Index2D(0, 0), 2);
    ...
    void testAllDistance_Simple() {
        _m3_3.setCyclic(false);
        Map2D dists = _m3_3.allDistance(new Index2D(1, 1), 1);
        assertNotNull(dists);
    ...
    void testAllDistance_Cyclic() {
        Map map = new Map(5, 5, 0);
        map.setCyclic(true);
        Map2D dists = map.allDistance(new Index2D(0, 0), 1);
    ...
    void testShortestPath_Blocked() {
        ...
        map.setPixel(1, 0, 1);
        map.setPixel(1, 1, 1);
        assertNull(map.shortestPath(new Index2D(0, 0), new Index2D(2, 2), 1));
    }
}